    ...
    <AnimatePresence>
      <motion.div className="w-full h-full fixed overflow-auto start-0 top-0 flex justify-center items-center  z-50  ">
        ...
        <motion.div
          ...
          animate="visible"
          exit="exit"
          className="w-[90%] absolute md:w-[500px] h-fit z-20 rounded-lg drop-shadow-2xl   top-10 flex flex-col gap-5 justify-center items-center bg-modal_container text-modal_copyright border-[1px] border-white hover:border-btn_color  p-2 md:p-10 mx-auto"
        >
